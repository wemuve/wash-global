...
-- Get the category ID for car detailing (we'll need to use it in the next insert)
...
-- Add new package tiers specifically for car detailing with vehicle size considerations
INSERT INTO public.package_tiers (name, description, type, price_multiplier, features) VALUES
('Small Vehicle', 'For compact cars, sedans, and hatchbacks', 'size_based', 1.00, ARRAY['Standard pricing', 'Quick service', 'Suitable for small vehicles']),
('Medium Vehicle', 'For SUVs, crossovers, and mid-size vehicles', 'size_based', 1.3, ARRAY['Medium vehicle pricing', 'Extended service time', 'Suitable for SUVs and crossovers']),
('Large Vehicle', 'For trucks, large SUVs, and commercial vehicles', 'size_based', 1.6, ARRAY['Large vehicle pricing', 'Extended service time', 'Suitable for trucks and large vehicles']),
('Heavy Duty Clean', 'For heavily soiled vehicles requiring extra attention', 'condition_based', 1.4, ARRAY['Extra cleaning time', 'Specialized products', 'Heavy soil removal']);
...
-- Add comment to document the vehicle information columns
